                    ...
                    <tbody>
                        ...
                        foreach ($rowInstructorMajor as $index => $rowInstructorMajors): ?>
                            <tr>
                                ...
                                <td> <a onclick="return confirm ('Are you sure?')" href="?page=tambah-instructor-major&delete=<?php echo $rowInstructorMajors['id'] ?> & id_instructor = <?php echo $rowInstructorMajors['id'] ?> " class="btn btn-danger btn-sm">Delete</a></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
